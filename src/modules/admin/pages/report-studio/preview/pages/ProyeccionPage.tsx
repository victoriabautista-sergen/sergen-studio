  ...
  return (
    <div className="flex flex-col h-full text-[12px] leading-relaxed" style={{ fontFamily: "'Inter', sans-serif", color: "#1B3A5C" }}>
      <div className="flex-1">
        ...
        <p className="text-[12px] mb-4" style={{ color: "#1B3A5C" }}>
        ...
        {hasItems ? (
          <>
            ...
            <div className="border border-gray-300 rounded p-3 mb-3 flex justify-between items-start">
              ...
              <div className="text-right">
                ...
                <p className="text-[12px] italic" style={{ color: "#E8792B" }}>Proyectado Promedio</p>
              ...
              <tbody>
                {projectedItems.map((item, i) => (
                    ...
                    >
                      ...
                      <td className={`${borderStyle} px-1.5 py-0.5 text-center`} style={{ color: item.is_potencia ? "#dc2626" : "#1B3A5C", fontWeight: item.is_potencia ? 700 : 400 }}>{item.unidad}</td>
            ...
            >
              <p className="text-[12px] font-semibold mb-2" style={{ color: "#1B3A5C" }}>Análisis de desviación</p>
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center text-gray-400 min-h-[150px]">
            <p className="text-[14px]">Completa la Hoja 3 para generar la factura proyectada</p>
          </div>
        )}
      </div>
