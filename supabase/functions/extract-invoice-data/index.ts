...
- Para cada item, clasifícalo como "gravado" (sujeto a IGV), "exonerado" (no sujeto a IGV, aparece en OP. EXONERADA) o "inafecta" (no sujeto a IGV, aparece en OP. INAFECTAS). Usa los montos de la factura para determinar la clasificación: los ítems cuya suma coincide con OP. EXONERADA son "exonerado", los que coinciden con OP. INAFECTAS son "inafecta", el resto son "gravado". Si la factura solo tiene OP. INAFECTAS y no OP. EXONERADA (o viceversa), clasifica los ítems no gravados según corresponda.${exonerado_keywords?.length ? `\n- REGLA DE CONCESIONARIA: Los siguientes conceptos son SIEMPRE no gravados para esta concesionaria: ${(exonerado_keywords as string[]).join(", ")}. Clasifícalos como "inafecta" si la factura usa OP. INAFECTAS, o como "exonerado" si usa OP. EXONERADA.` : " NO asumas que un concepto es exonerado o inafecta a menos que la factura lo indique explícitamente."}
